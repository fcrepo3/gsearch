...
-->
	...
	<xsl:include href="CONFIGPATH/rest/testCommon.xslt"/>
						...
						<td>
							<xsl:text> </xsl:text>Index name: 
								<select name="indexName">
									<option value="TestOnLucene">TestOnLucene</option>
								</select>
							<xsl:text> </xsl:text>restXslt: 
								<select name="restXslt">
									<option value="testBrowseIndexToHtml">testBrowseIndexToHtml</option>
