...
<xsl:stylesheet version="1.0"
	...
	<xsl:variable name="PID"><xsl:value-of select="/foxml:digitalObject/@PID"/>$PDF</xsl:variable>
	<xsl:variable name="DSID"><xsl:value-of select="/foxml:digitalObject/foxml:datastream/foxml:datastreamVersion[@MIMETYPE='application/pdf']/../@ID"/></xsl:variable>
