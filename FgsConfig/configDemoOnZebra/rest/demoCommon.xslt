...
-->
	...
	<xsl:template match="/resultPage">
		<html>
			<head>
				<title>REST Client Demo of Fedora Generic Search Service (configDemoOnZebra)</title>
			...
			<body>
				<div id="header">
					<a href="" id="logo"></a>
					<div id="title">
						<h1>REST Client Demo of Fedora Generic Search Service (configDemoOnZebra)</h1>
					</div>
				</div>
