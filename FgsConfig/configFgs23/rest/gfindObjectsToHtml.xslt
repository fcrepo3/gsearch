...
-->
	...
	<xsl:include href="commonToHtml.xslt"/>
				...
				<tr>
					<td width="100">
						...
						<a>
							...
							<xsl:attribute name="href">?operation=gfindObjects&amp;query=PID:%22<xsl:value-of select="$PIDVALUE"/>%22&amp;restXslt=getIndexDocumentToHtml&amp;fieldMaxLength=0&amp;snippetsMax=0</xsl:attribute>
