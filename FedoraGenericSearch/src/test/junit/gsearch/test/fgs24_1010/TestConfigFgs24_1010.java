 ...
 * 
 * the test suite will perform tests on both Lucene and Solr
 */
public class TestConfigFgs24_1010
        extends FgsTestCase {

    // Supports legacy test runners
    public static junit.framework.Test suite() {
        TestSuite suite = new TestSuite("configTestOnFgs24_1010 TestSuite");
        suite.addTestSuite(TestConfigFgs24_1010.class);
